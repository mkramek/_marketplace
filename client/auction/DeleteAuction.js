...
export default function DeleteAuction(props) {
    ...
    return (<span>
        <IconButton aria-label="Usuń" onClick={clickButton} color="secondary">
            <DeleteIcon />
        </IconButton>

        <Dialog open={open} onClose={handleRequestClose}>
            <DialogTitle>{"Usuń " + props.auction.itemName}</DialogTitle>
            <DialogContent>
                <DialogContentText>
                    potwierdź aby usunąć aukcje {props.auction.itemName}.
                </DialogContentText>
            </DialogContent>
            <DialogActions>
