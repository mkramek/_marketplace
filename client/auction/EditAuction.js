...
export default function EditShop({ match }) {
    ...
    const clickSubmit = () => {
        if (auction.bidEnd < auction.bidStart) {
            setError("Aukcja nie może zakończyć się przed rozpoczęciem")
        } else {
            ...
            auction.minPrice && auctionData.append('minPrice', auction.minPrice)
        ...
        <Card className={classes.card}>
            <CardContent>
                ...
                <TextField
                    ...
                    margin="normal"
                /><br />
                <TextField id="startingBid" label="Początkowa cena (zł)" className={classes.textField} value={auction.startingBid} onChange={handleChange('startingBid')} margin="normal" /><br />
                <br />
                <TextField
                    id="datetime-local"
                    label="Czas rozpoczęcia aukcji"
                    type="datetime-local"
            ...
            <CardActions>
                <Button color="primary" variant="contained" onClick={clickSubmit} className={classes.submit}>Zaktualizuj</Button>
            </CardActions>
        </Card>
    </div>)
}
