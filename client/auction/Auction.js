        ...
        <div className={classes.root}>
            <Card className={classes.card}>
                <CardHeader
                    ...
                    subheader={<span>
                        {currentDate < new Date(auction.bidStart) && 'Aukcja nie rozpoczęta'}
                        {currentDate > new Date(auction.bidStart) && currentDate < new Date(auction.bidEnd) && 'Aukcja w toku'}
                        {currentDate > new Date(auction.bidEnd) && 'Aukcja zakończona'}
                    </span>}
                />
                    ...
                    <Grid item xs={7} sm={7}>
                        {currentDate > new Date(auction.bidStart)
                            ? (<>
                                ...
                                {!auth.isAuthenticated() && <Typography>Please, <Link to='/signin'>Zaloguj się</Link> zamieść swoją ofertę</Typography>}
