...
import { Card, InputLabel, Select, MenuItem, CardActions, CardContent, Button, TextField, Typography, Icon, FormControl } from '@material-ui/core'
...
export default function NewProduct({ match }) {
    ...
    const clickSubmit = () => {
        ...
        values.unit && productData.append('unit', values.unit);
