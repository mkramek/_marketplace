    ...
    return (
        <Card className={classes.card}>
            ...
            <Typography type="subheading" component="h2" className={classes.subheading}>
                Kod zamówienia: <strong>{order._id}</strong> <br /> Złożone dnia{(new Date(order.created)).toDateString()}
            </Typography><br />
            <Grid container spacing={4}>
                ...
                <Grid item xs={5} sm={5}>
                    <Card className={classes.innerCard}>
                        ...
                        <Typography type="subheading" component="h3" className={classes.thanks} color="primary">Dziękujemy za wspólne zakupy! <br />Śledź status przesyłki na tej stronie.</Typography>
                    </Card>
                </Grid>
            </Grid>
        </Card>
